...
class Texture {
 public:
  ...
  // load from memory
  void load_image_from_memory(TextureLevel level,
                              TextureInternalFormat internal_format, int width,
                              int height, TextureBorder border,
                              TextureFormat format, GLType gl_type,
                              const void* data);
